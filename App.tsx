...
const CurrentSeasonTeamRoute: React.FC = () => {
  const [searchParams] = useSearchParams();
  const requestedSeason = searchParams.get('season');

  if (isSeasonId(requestedSeason) && requestedSeason !== CURRENT_SEASON_ID) {
        ...
        <AppErrorBoundary>
          <Suspense fallback={<PageSkeleton />}>
            <Routes>
              ...
              <Route path="/teams/:id" element={<CurrentSeasonTeamRoute />} />
